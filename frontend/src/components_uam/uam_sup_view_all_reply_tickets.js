                                ...
                                return (
                                    <tr className="uam-summary-table-row" key={supportTicket._id}>
                                        <td className="uam-summary-table-data">{
                                              new Date(supportTicket.replyTicketDate).toISOString().split('T')[0]
                                        }
                                        </td>
                                        ...
                                        <td className="uam-summary-table-data">{supportTicket.supAgentId}</td>                                      
                                        <td className="uam-summary-table-data">
                                            {clientDetails[supportTicket.clientId]
                                                ? `${clientDetails[supportTicket.clientId].fname} `
                                                : 'Loading...'}
                                        </td>                                        
                                        <td className="uam-summary-table-data">{supportTicket.replyTicketMsg}</td>
                                        <td className="uam-summary-table-data">{supportTicket.replyTicketstatus}</td>                                         
