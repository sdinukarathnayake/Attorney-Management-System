    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                localStorage.setItem('userName', response.data.financeManager.fName);
                localStorage.setItem('userNic', response.data.financeManager.nic);

                // Redirect to ClientPortalHome with the user's ID
                navigate(`/finance-manager-dashboard/${response.data.financeManager.userId}`);
            }
        } catch (err) {
    ...
    return (
        ...
        <hr/>
            ...
            <div className="login-form-container">
                <h2 className="">Login Finance manager</h2>
...
export default FinanceManagerLogin;