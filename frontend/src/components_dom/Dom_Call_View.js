...
function Dom_Call_View () {
    ...
    useEffect(() => {
        ...
        const document_call_update_page = (id) => {
            navigate(`/update/${id}`); // Redirect to update page with id
          };
...
<div>
    ...
    <h1 className="dom-dashboard-h1">Document Call View</h1>
    ...
    <div>
      <div ref={ComponenetsRef}>
          ...
          <button type="button" className="dom-dashboard-btn-edit" onClick={() => document_call_update_page(showdocumentCall._id)}>Edit</button>
