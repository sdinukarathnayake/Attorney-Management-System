...
function Dashboard() {
    ...
    useEffect(() => {
        function getAppointmentRequests() {
            axios.get(`http://localhost:8070/appointmentrequest/`).then((res) => {
    ...
    return (
        <div>
            ...
            <div className="apm-container">
                <h2 className="apm-header">Appointment Manager Manager</h2>
                            ...
                            appointmentrequest.map(appointmentrequest => {
                                return (
                                    <tr className="apm-summary-table-row" key={appointmentrequest._id}>
                                        ...
                                        <td className="apm-summary-table-action"><a className="apm-summary-table-button" href={`/appointment-manager-dashboard/view-appointment-request/${appointmentrequest._id}`}>View Request</a></td>
                                    </tr>
                                )
                            })
                        }
